    ...
    <div className="d-flex flex-column">
      ...
      <section class=" bg-white p-4 mx-5 rounded mt-4 d-md-none wave">
        ...
        <div className="d-flex justify-content-between mt-4">
          ...
          <div className="bg-warning rounded-3 text-white p-2 mx-5 text-center d-md-none">
            Waiting for payment
          </div>
        </div>
        <p
        ...
        <div class="d-flex mb-5 mx-5">
          ...
          <div class="mt-5 d-flex flex-column flex-fill">
            ...
            <section class="container bg-white p-4 ms-2 rounded mt-4">
              ...
              <div className="d-flex justify-content-between mt-4">
                <p className="fw-bold text-secondary">Status</p>
                <div className="bg-warning rounded-3 text-white p-2 mx-5 w-25 text-center d-none d-md-block">
                  Waiting for payment
                </div>
                <div className="bg-warning rounded-3 text-white p-2 mx-5 text-center d-md-none">
                  Waiting for payment
